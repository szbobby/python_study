...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBox_classify.setItemText(0, _translate("Form", "AA"))
        self.comboBox_classify.setItemText(1, _translate("Form", "A1"))
        self.comboBox_classify.setItemText(2, _translate("Form", "A2"))
        self.comboBox_classify.setItemText(3, _translate("Form", "A3"))
