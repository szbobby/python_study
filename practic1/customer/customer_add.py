...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(120, 110, 161, 231))
        ...
        self.label_customerID = QtWidgets.QLabel(Form)
        self.label_customerID.setGeometry(QtCore.QRect(120, 80, 101, 31))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_customerID.setText(_translate("Form", "0000"))
...
### 以下开始连接数据库
    ...
    def handle_click(self):
        lens=self.dblen()
        self.label_customerID.setText(str(lens+1))
        self.show()
