...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_shipmentID = QtWidgets.QLabel(Form)
        self.label_shipmentID.setGeometry(QtCore.QRect(100, 70, 101, 31))
        self.label_shipmentID.setObjectName("label_shipmentID")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "出货序号"))
...
"与联系人"))
        ...
        self.label_shipmentID.setText(_translate("Form", "0000"))
