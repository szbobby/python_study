...
#        print ("pageData()打开数据库成功")
    ...
    def lineDisplay(self,l): #在edit中显示browser 1-5行的内容
        ...
        if l==1:
            ...
            self.lineEdit_shipDate.setText(str(data[p-1][1]))
            ...
            self.lineEdit_payRemind.setText(str(data[p-1][11]))
            ...
            self.lineEdit_shipDate.setText(str(data[p][1]))
            ...
            self.lineEdit_payRemind.setText(str(data[p][10]))
            self.plainTextEdit_payRecord.setPlainText(str(data[p][11]))
            ...
            self.lineEdit_paid.setText(str(data[p+1][9]))
            self.lineEdit_payRemind.setText(str(data[p+1][10]))
            self.plainTextEdit_payRecord.setPlainText(str(data[p+1][11]))
            self.plainTextEdit_shipto.setPlainText(str(data[p+1][12]))
            self.plainTextEdit_remark.setPlainText(str(data[p+1][13]))
            ...
            self.lineEdit_shipDate.setText(str(data[p+2][1]))
            ...
            self.lineEdit_payRemind.setText(str(data[p+2][10]))
            self.plainTextEdit_payRecord.setPlainText(str(data[p+2][11]))
            ...
            self.lineEdit_shipDate.setText(str(data[p+3][1]))
            ...
            self.lineEdit_payRemind.setText(str(data[p+3][10]))
            self.plainTextEdit_payRecord.setPlainText(str(data[p+3][11]))
