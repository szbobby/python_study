...
def customerE_click1():
    print("edit_click1 been cliked")
    b=customerB.label_id1.text()
    print("b=",b)
    return b
#    customerB.pushButton_edit1.clicked.connect(lambda:customerE.handle_click1(b))
...
# browser页面点击“编辑”弹出编辑窗口
    customerB.pushButton_edit1.clicked.connect(customerE_click1)
