...
#        content=[shipmentID,shipDate,customer,sales,production,model,macID,unitPrice,number,paid,paidRecord,payRemind,shipTo,remark]
        content=[shipDate,customer,sales,production,model,macID,unitPrice,number,paid,paidRecord,payRemind,shipTo,remark]
...
#            curs.execute("insert into shipment(shipmentID,shipDate,customer,sales,production,model,macID,unitPrice,number,paid,paidRecord,payRemind,shipTo,remark) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",content)
            curs.execute("insert into shipment(shipDate,customer,sales,production,model,macID,unitPrice,number,paid,paidRecord,payRemind,shipTo,remark) values (?,?,?,?,?,?,?,?,?,?,?,?,?)",content)
            print("here now")
            curs.close()  #关闭游标
            conn.commit() #保存数据库
            conn.close() #关闭数据库连接
