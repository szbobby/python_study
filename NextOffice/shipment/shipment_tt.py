...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.plainTextEdit_remark_3 = QtWidgets.QPlainTextEdit(Form)
        self.plainTextEdit_remark_3.setGeometry(QtCore.QRect(490, 320, 351, 61))
        self.plainTextEdit_remark_3.setObjectName("plainTextEdit_remark_3")
        ...
        self.calendarWidget_ship = QtWidgets.QCalendarWidget(Form)
        self.calendarWidget_ship.setGeometry(QtCore.QRect(140, 110, 261, 201))
        self.calendarWidget_ship.setInputMethodHints(QtCore.Qt.ImhNone)
        self.calendarWidget_ship.setGridVisible(True)
        self.calendarWidget_ship.setHorizontalHeaderFormat(QtWidgets.QCalendarWidget.ShortDayNames)
        self.calendarWidget_ship.setNavigationBarVisible(True)
        self.calendarWidget_ship.setDateEditEnabled(True)
        self.calendarWidget_ship.setObjectName("calendarWidget_ship")
        ...
        self.calendarWidget_pay = QtWidgets.QCalendarWidget(Form)
        self.calendarWidget_pay.setGeometry(QtCore.QRect(600, 250, 261, 201))
        self.calendarWidget_pay.setInputMethodHints(QtCore.Qt.ImhNone)
        self.calendarWidget_pay.setGridVisible(True)
        self.calendarWidget_pay.setHorizontalHeaderFormat(QtWidgets.QCalendarWidget.ShortDayNames)
        self.calendarWidget_pay.setNavigationBarVisible(True)
        self.calendarWidget_pay.setDateEditEnabled(True)
        self.calendarWidget_pay.setObjectName("calendarWidget_pay")

        self.retranslateUi(Form)
        self.pushButton_save.clicked.connect(self.saveToSqlite)
        self.pushButton_cancel.clicked.connect(self.close)
        self.dateEdit_ship.dateChanged['QDate'].connect(self.calendarWidget_ship.setSelectedDate)
        self.calendarWidget_ship.clicked['QDate'].connect(self.dateEdit_ship.setDate)
        self.dateEdit_pay.dateChanged['QDate'].connect(self.calendarWidget_pay.setSelectedDate)
        self.calendarWidget_pay.clicked['QDate'].connect(self.dateEdit_pay.setDate)
        self.calendarWidget_ship.clicked['QDate'].connect(self.calendarWidget_ship.hide)
        self.calendarWidget_pay.clicked['QDate'].connect(self.calendarWidget_pay.hide)
...
#        shipDate=str(self.dateEdit_ship.text())
        shipDate=str(self.dateEdit_ship.selectdate())
...
class MyForm ( QWidget, Ui_Form ):
    def __init__(self):
        ...
        self.calendarWidget_ship.hide()
        self.calendarWidget_pay.hide()
        self.dateEdit_ship.dateChanged.connect(self.calendarWidget_ship.show)
        self.dateEdit_pay.dateChanged.connect(self.calendarWidget_pay.show)
...
#    w.lineDisplay()
    w.show()
#    w.dateEdit_ship.dateChanged.connect(w.calendarWidget_ship.show)
#    w.dateEdit_pay.dateChanged.connect(w.calendarWidget_pay.show)
    w.dateEdit_ship.dateChanged.connect(w.calendarWidget_ship.show)
    w.dateEdit_pay.dateChanged.connect(w.calendarWidget_pay.show)

    ww=calendarWidget_ship.clicked['QDate'].connect(print(dateEdit_ship.text))
